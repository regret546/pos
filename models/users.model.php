...
class UsersModel{
	...
	static public function mdlAddUser($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(name, user, password, profile, photo, status, lastLogin) VALUES (:name, :user, :password, :profile, :photo, :status, :lastLogin)");
		...
		$stmt -> bindParam(":lastLogin", $data["lastLogin"], PDO::PARAM_STR);
